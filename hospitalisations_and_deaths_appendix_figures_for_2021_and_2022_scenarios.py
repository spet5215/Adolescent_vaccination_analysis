...
fig.suptitle('Impact of Adolescent Vaccination on the Cumulative Number of Hospitalisations', y=0.98, fontsize = 14)
...
fig, ((ax1),(ax2),(ax3)) = pl.subplots(3,1,figsize = (8,12), dpi = 100)
fig.suptitle('Impact of Adolescent Vaccination on the Cumulative Number of Hospitalisations (ICUs)', y=0.98, fontsize = 14)
...
fig, ((ax1),(ax2),(ax3)) = pl.subplots(3,1,figsize = (8,12), dpi = 100)
fig.suptitle('Impact of Adolescent Vaccination on the Cumulative Number of Deaths', y=0.98, fontsize = 14)
...
fig, ((ax8)) = pl.subplots(1,1,figsize = (8,3.5), dpi = 100)
fig.suptitle('Impact of the Adolescent Booster Vaccine on the Cumulative Number of Hospitalisations', y=0.98, fontsize = 12)
...
fig, ((ax8)) = pl.subplots(1,1,figsize = (8,3.5), dpi = 100)
fig.suptitle('Impact of the Adolescent Booster Vaccine on the Cumulative Number of Hospitalisations (ICUs)', y=0.98, fontsize = 12)
...
fig, ((ax8)) = pl.subplots(1,1,figsize = (8,3.5), dpi = 100)
fig.suptitle('Impact of the Adolescent Booster Vaccine on the Cumulative Number of Deaths', y=0.98, fontsize = 12)
